...
namespace CIB.PhoneBook.DAL.BaseClasses
{
    public class Repository<T> : IRepository<T> , IDisposable where T : class
    {
        ...
        public virtual void SaveChanges()
        {
            try
            {
                //this elaborate save method is if you were to add auditing with libraries such as EntityAudit
                /*Context.DbContext.AddAuditCustomField("IdChangedBy", request.IdChangedBy);
                Context.DbContext.AddAuditCustomField("Username", request.Username);
                Context.DbContext.AddAuditCustomField("IdDealer", request.IdDealer);
                Context.DbContext.AddAuditCustomField("DealerName", request.DealerName);
                Context.DbContext.AddAuditCustomField("IpAddress", request.IpAddress);
        ...
        public Repository<T> SaveAndContinue()
        {
            try
            {
                SaveChanges();
        ...
        public Repository<T> BeginTransaction()
        {
