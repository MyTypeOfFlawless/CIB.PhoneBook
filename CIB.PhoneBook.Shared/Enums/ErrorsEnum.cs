...
{
    [Help(@"string contactAction = ContactActionsEnum.Description();"), DataContract(Namespace = "CIB.PhoneBook.Shared.Enums", Name = "ErrorsEnum")]
    public enum ErrorsEnum
    {
        ...
        UserInactive = 2,
        [Description("User has been deleted."), FriendlyErrorMessage("The iser has been deleted."), EnumMember(Value = "UserDeleted")]
        UserDeleted = 3,
