...
namespace CIB.PhoneBook.Shared.Utilities
{
    ...
    public class DataEncryptorUtility
    {
        #region Factory

        public DataEncryptorUtility()
        {
            this.Algorithm = new TripleDESCryptoServiceProvider();
            this.Algorithm.Padding = PaddingMode.PKCS7;
        }

        public DataEncryptorUtility(TripleDESCryptoServiceProvider keys)
        {
            this.Algorithm = keys;
        }

        public DataEncryptorUtility(byte[] key, byte[] iv)
        {
            this.Algorithm = new TripleDESCryptoServiceProvider();
            this.Algorithm.Padding = PaddingMode.PKCS7;
