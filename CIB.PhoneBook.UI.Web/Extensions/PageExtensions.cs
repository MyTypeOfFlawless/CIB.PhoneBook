using System;
using System.Web.UI;
using CIB.PhoneBook.UI.Web.Attributes;
using Telerik.Web.UI;

namespace CIB.PhoneBook.UI.Web.Extensions
{
    public static class PageExtensions
    {
        ...
        {
            //new ErrorHandler("Web").HandleError(ex, new RequestBase());
            if (redirect)
            {
                page.Server.Transfer("HttpGenericErrorPage.aspx", true);
            }
            page.ShowError("An error occured.");
        }
    }
